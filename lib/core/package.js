...
var Package = function (name, endpoint, manager) {
  ...
  this.dependencies = {};
  this.substitutions = manager ? manager.substitutions : {};
  this.json         = {};
  this.name         = name;
...
Package.prototype.addDependencies = function () {
  ...
  //console.log({name: this.name, dependencies: dependencies, substitutions: this.substitutions});

  if (this.manager) {
    console.log('manager', this.manager);
    dependencies = this.manager.resolveSubstitutions(dependencies);
  }
